...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onResume() {
        super.onResume();
        Toast.makeText(getApplicationContext(), "Tap mod activated", Toast.LENGTH_LONG).show();
        ...
        View.OnTouchListener stringA = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    switch (v.getId()){
                        case R.id.buttonA0:
                            a = MediaPlayer.create(getApplicationContext(), R.raw.a0);break;
                        case R.id.buttonA1:
                            switch (zeroLad){
                            ...
                            Button button0 = (Button) findViewById(R.id.buttonA0); button0.setEnabled(false);
                            break;
                        case R.id.buttonA2:
                            switch (zeroLad){
                            ...
                            Button button00 = (Button) findViewById(R.id.buttonA0); button00.setEnabled(false);
                        ...
                        case R.id.buttonA3:
                            ...
                            Button button000 = (Button) findViewById(R.id.buttonA0); button000.setEnabled(false);
                        ...
                        case R.id.buttonA4:
                            ...
                            Button button0000 = (Button) findViewById(R.id.buttonA0); button0000.setEnabled(false);
                        ...
                        case R.id.buttonA5:
                            ...
                            Button button00000 = (Button) findViewById(R.id.buttonA0); button00000.setEnabled(false);
                ...
                if (event.getAction() == MotionEvent.ACTION_UP){
                    Button button0 = (Button) findViewById(R.id.buttonA0); button0.setEnabled(true);
        ...
        View.OnTouchListener stringB = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    switch (v.getId()){
                        case R.id.buttonB0:
                            b = MediaPlayer.create(getApplicationContext(), R.raw.b0);break;
                        case R.id.buttonB1:
                            switch (zeroLad){
                            ...
                            Button button0 = (Button) findViewById(R.id.buttonB0); button0.setEnabled(false);
                            break;
                        case R.id.buttonB2:
                            switch (zeroLad){
                            ...
                            Button button00 = (Button) findViewById(R.id.buttonB0); button00.setEnabled(false);
                        ...
                        case R.id.buttonB3:
                            ...
                            Button button000 = (Button) findViewById(R.id.buttonB0); button000.setEnabled(false);
                        ...
                        case R.id.buttonB4:
                            ...
                            Button button0000 = (Button) findViewById(R.id.buttonB0); button0000.setEnabled(false);
                        ...
                        case R.id.buttonB5:
                            ...
                            Button button00000 = (Button) findViewById(R.id.buttonB0); button00000.setEnabled(false);
                ...
                if (event.getAction() == MotionEvent.ACTION_UP){
                    Button button0 = (Button) findViewById(R.id.buttonB0); button0.setEnabled(true);
        ...
        View.OnTouchListener stringC = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    switch (v.getId()){
                        case R.id.buttonC0:
                            c = MediaPlayer.create(getApplicationContext(), R.raw.c0);break;
                        case R.id.buttonC1:
                            switch (zeroLad){
                            ...
                            Button button0 = (Button) findViewById(R.id.buttonC0); button0.setEnabled(false);
                            break;
                        case R.id.buttonC2:
                            switch (zeroLad){
                            ...
                            Button button00 = (Button) findViewById(R.id.buttonC0); button00.setEnabled(false);
                        ...
                        case R.id.buttonC3:
                            ...
                            Button button000 = (Button) findViewById(R.id.buttonC0); button000.setEnabled(false);
                        ...
                        case R.id.buttonC4:
                            ...
                            Button button0000 = (Button) findViewById(R.id.buttonC0); button0000.setEnabled(false);
                        ...
                        case R.id.buttonC5:
                            ...
                            Button button00000 = (Button) findViewById(R.id.buttonC0); button00000.setEnabled(false);
                ...
                if (event.getAction() == MotionEvent.ACTION_UP){
                    Button button0 = (Button) findViewById(R.id.buttonC0); button0.setEnabled(true);
        ...
        View.OnTouchListener stringD = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    switch (v.getId()){
                        case R.id.buttonD0:
                            d = MediaPlayer.create(getApplicationContext(), R.raw.d0);break;
                        case R.id.buttonD1:
                            switch (zeroLad){
                            ...
                            Button button0 = (Button) findViewById(R.id.buttonD0); button0.setEnabled(false);
                            break;
                        case R.id.buttonD2:
                            switch (zeroLad){
                            ...
                            Button button00 = (Button) findViewById(R.id.buttonD0); button00.setEnabled(false);
                        ...
                        case R.id.buttonD3:
                            ...
                            Button button000 = (Button) findViewById(R.id.buttonD0); button000.setEnabled(false);
                        ...
                        case R.id.buttonD4:
                            ...
                            Button button0000 = (Button) findViewById(R.id.buttonD0); button0000.setEnabled(false);
                        ...
                        case R.id.buttonD5:
                            ...
                            Button button00000 = (Button) findViewById(R.id.buttonD0); button00000.setEnabled(false);
                ...
                if (event.getAction() == MotionEvent.ACTION_UP){
                    Button button0 = (Button) findViewById(R.id.buttonD0); button0.setEnabled(true);
        ...
        View.OnTouchListener stringE = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    switch (v.getId()){
                        case R.id.buttonE0:
                            e = MediaPlayer.create(getApplicationContext(), R.raw.e0);break;
                        case R.id.buttonE1:
                            switch (zeroLad){
                            ...
                            Button button0 = (Button) findViewById(R.id.buttonE0); button0.setEnabled(false);
                            break;
                        case R.id.buttonE2:
                            switch (zeroLad){
                            ...
                            Button button00 = (Button) findViewById(R.id.buttonE0); button00.setEnabled(false);
                        ...
                        case R.id.buttonE3:
                            ...
                            Button button000 = (Button) findViewById(R.id.buttonE0); button000.setEnabled(false);
                        ...
                        case R.id.buttonE4:
                            ...
                            Button button0000 = (Button) findViewById(R.id.buttonE0); button0000.setEnabled(false);
                        ...
                        case R.id.buttonE5:
                            ...
                            Button button00000 = (Button) findViewById(R.id.buttonE0); button00000.setEnabled(false);
                ...
                if (event.getAction() == MotionEvent.ACTION_UP){
                    Button button0 = (Button) findViewById(R.id.buttonE0); button0.setEnabled(true);
        ...
        View.OnTouchListener stringF = new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    switch (v.getId()){
                        case R.id.buttonF0:
                            f = MediaPlayer.create(getApplicationContext(), R.raw.f0);break;
                        case R.id.buttonF1:
                            switch (zeroLad){
                            ...
                            Button button0 = (Button) findViewById(R.id.buttonF0); button0.setEnabled(false);
                            break;
                        case R.id.buttonF2:
                            switch (zeroLad){
                            ...
                            Button button00 = (Button) findViewById(R.id.buttonF0); button00.setEnabled(false);
                        ...
                        case R.id.buttonF3:
                            ...
                            Button button000 = (Button) findViewById(R.id.buttonF0); button000.setEnabled(false);
                        ...
                        case R.id.buttonF4:
                            ...
                            Button button0000 = (Button) findViewById(R.id.buttonF0); button0000.setEnabled(false);
                        ...
                        case R.id.buttonF5:
                            ...
                            Button button00000 = (Button) findViewById(R.id.buttonF0); button00000.setEnabled(false);
                ...
                if (event.getAction() == MotionEvent.ACTION_UP){
                    Button button0 = (Button) findViewById(R.id.buttonF0); button0.setEnabled(true);
        ...
        Button buttonA0 = (Button) findViewById(R.id.buttonA0);buttonA0.setOnTouchListener(stringA);
        ...
        Button buttonB0 = (Button) findViewById(R.id.buttonB0);buttonB0.setOnTouchListener(stringB);
        ...
        Button buttonC0 = (Button) findViewById(R.id.buttonC0);buttonC0.setOnTouchListener(stringC);
        ...
        Button buttonD0 = (Button) findViewById(R.id.buttonD0);buttonD0.setOnTouchListener(stringD);
        ...
        Button buttonE0 = (Button) findViewById(R.id.buttonE0);buttonE0.setOnTouchListener(stringE);
        ...
        Button buttonF0 = (Button) findViewById(R.id.buttonF0);buttonF0.setOnTouchListener(stringF);
